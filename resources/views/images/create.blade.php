<div class="wrapper container-fluid">
    {!! Form::open(['url'=>route('imageCont'),'class'=>'form-horizontal', 'method' =>'POST','enctype'=>'multipart/from-data','files'=>true]) !!}

    <div class="form-group">
        {!! Form::label('title','Назва:',['class' =>'col-xs-02 control-label']) !!}
        <div class="col-xs-8">
            {!! Form::text('title', old('title'),['class'=>'form-control','placeholder'=>'Введіть назву:']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::file('watermark',['class'=>'filestyle','data-buttonText'=>'Виберіть зображення','data-buttonName'=>'btn-primary','data-placeholder'=>'Файлу немає']) !!}
        </div>
    </div>
