...
return [
    ...
    */
    ...
    'required_if'          => "Поле :attribute є обов'язковим для заповнення, коли :other - :value.",
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'Доступно',
        'size'                  => 'Розмір',
        'nova_poshta_city'      => 'Нова пошта (місто)',
        'nova_poshta_branch'    => 'Нова пошта (відділення)',
        'delivery_address'      => 'Адресна доставка',
        'new_city'              => 'Нове місто',
        'new_address'           => 'Нове вулиця',
        'payment_name'          => 'Оплата',
        'legal_person'          => 'Юридична особа',
        'radiobutton'           => 'Доставка',

    ],

    'values' => [
        'payment_name' => [
            'no-cash' => 'Безготівкова',
        ],
        'radiobutton'  => [
            'nova_poshta_address' => 'Нова пошта',
        ],
    ],
];
