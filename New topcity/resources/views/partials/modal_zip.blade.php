<div class="modal fade" id="modal_zip" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="popup__send-message modal-content">
            <div class="send-message">
                <h2 class="send-message__title">{{ __('modal.product_added_to_the_ZIP') }}</h2>
            </div>
            <div class="send-message__button">
                <a class="message__button" href="{{ route('zip.index') }}">{{ __('modal.view_your_zips') }}</a>
            </div>
