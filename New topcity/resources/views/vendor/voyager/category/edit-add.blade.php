                    ...
                    <!-- CSRF TOKEN -->
                        ...
                        <!-- Adding / Editing -->
                            ...
                            <div class="form-group col-md-12">
                                <label class="control-label" for="category">Родитель категории</label>
                                <select name="category" id="category" class="form-control">
                                    <option value="0" @if($dataTypeContent->parent_id == 0) selected @endif >Без
                                        категории
                                    </option>
                                    @if($nodes)
                                        @include('vendor.voyager.category.traverse',['categories' => $nodes, 'space' => ''])
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="panel-footer">
                            <button type="submit" class="btn btn-primary save">
                                {{ __('voyager::generic.save') }}</button>
                        </div>
                    </form>
                    ...
                    <div class="panel panel-bordered">
                        ...
                        <!-- CSRF TOKEN -->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group col-md-12">
                                    <label class="control-label" for="file">Загрузити продукти в категорію</label>
                                    <input name="file" id="file" type="file" required>
                                    <a href="{{ url('img\example_product.csv') }}">Приклад</a>
                                </div>
                            </div><!-- panel-body -->
