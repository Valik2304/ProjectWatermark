...
class DataRowsTableSeederCustom extends Seeder
{
    ...
    public function run()
    {
        ...
        */
        ...
        $dataRow = $this->dataRow($productDataType, 'article');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($productDataType, 'seo_keywords');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text_area',
...
//        }
        ...
        */
        ...
        $vacanciesDataType = DataType::where('slug', 'vacancies')->firstOrFail();

        $dataRow = $this->dataRow($vacanciesDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'hidden',
                'display_name'   => 'Id',
        ...
        $dataRow = $this->dataRow($vacanciesDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'text',
                'display_name'   => 'Name',
        ...
        $dataRow = $this->dataRow($vacanciesDataType, 'description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'rich_text_box',
                'display_name'   => 'Description',
        ...
        $dataRow = $this->dataRow($vacanciesDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'timestamp',
                'display_name'   => 'created at',
        ...
        $dataRow = $this->dataRow($vacanciesDataType, 'update_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'timestamp',
        ...
        */
        ...
        $mainSlidersDataType = DataType::where('slug', 'main-sliders')->firstOrFail();

        $dataRow = $this->dataRow($mainSlidersDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'hidden',
                'display_name'   => 'Id',
        ...
        $dataRow = $this->dataRow($mainSlidersDataType, 'title');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'text',
                'display_name'   => 'title',
        ...
        $dataRow = $this->dataRow($mainSlidersDataType, 'image');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'image',
                'display_name'   => 'image',
        ...
        $dataRow = $this->dataRow($mainSlidersDataType, 'link');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'text',
                'display_name'   => 'link',
        ...
        $dataRow = $this->dataRow($mainSlidersDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'timestamp',
                'display_name'   => 'created at',
        ...
        $dataRow = $this->dataRow($mainSlidersDataType, 'update_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'timestamp',
                'display_name'   => 'Update at',
        ...
        */
        ...
        $newsCategoryDataType = DataType::where('slug', 'news-categories')->firstOrFail();

        $dataRow = $this->dataRow($newsCategoryDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'hidden',
                'display_name'   => 'Id',
        ...
        $dataRow = $this->dataRow($newsCategoryDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'text',
                'display_name'   => 'Name',
        ...
        $dataRow = $this->dataRow($newsCategoryDataType, 'slug');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'text',
                'display_name'   => 'slug',
        ...
        $dataRow = $this->dataRow($newsCategoryDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'timestamp',
                'display_name'   => 'created at',
        ...
        $dataRow = $this->dataRow($newsCategoryDataType, 'update_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'timestamp',
                'display_name'   => 'Update at',
       ...
       */
        ...
        $newsCategoryDataType = DataType::where('slug', 'team-members')->firstOrFail();
        ...
        $dataRow = $this->dataRow($newsCategoryDataType, 'image');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'image',
                'display_name'   => 'image',
        ...
        $dataRow = $this->dataRow($newsCategoryDataType, 'description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'           => 'rich_text_box',
                'display_name'   => 'description',
